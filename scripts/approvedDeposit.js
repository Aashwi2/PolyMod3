...
const ABI = require("../artifacts/contracts/aashwi.sol/aashwi.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("aashwi");
  const nft = await NFT.attach("0x1C8Dc0f815034763aB7368eCbdDddF0840f880Af");
